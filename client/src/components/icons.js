const iconBrand = <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-check2-all" viewBox="0 0 16 16">
...
const iconUser = <img alt="" src="/media/profile_img.png" width="30" height="30" className="d-inline-block align-top" />

const icons = { iconBrand, iconDelete, iconEdit, iconPrivate, iconUser };
